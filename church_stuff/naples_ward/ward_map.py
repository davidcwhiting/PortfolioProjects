...
path = str(Path.home() / "Documents/naples_ward")
os.chdir(path)
...
def color_coding(row):
    if ((row['has_ministering_assignment'] == 'TRUE') or (row['has_ministering_assignment']=='1')) and row['has_ministering_brother'] == 'TRUE':
        return 'green'
    elif ((row['has_ministering_assignment'] == 'TRUE') or (row['has_ministering_assignment']=='1')) and (row['has_ministering_brother'] != 'TRUE' or row['has_ministering_brother'] != '1'):
        return 'blue'
    elif ((row['has_ministering_assignment'] != 'TRUE') or (row['has_ministering_assignment']!='1')) and ((row['has_ministering_brother'] == 'TRUE') or (row['has_ministering_brother'] =='1')):
        return 'purple'
    elif ((row['has_ministering_assignment'] != 'TRUE') or (row['has_ministering_assignment']!='1')) and (row['has_ministering_brother'] != 'TRUE' or row['has_ministering_brother'] != '1'):
...
rows = df_clean[['Name','HOH', 'Age', 'Gender', 'Street Address 1', 'Address 2', 'City', 'State', 'zip', 'Latitude', 'Longitude', 'has_ministering_assignment', 'has_ministering_brother', 'has_ministering_sister', 'color_coding_ministering']].dropna(subset=['Name', 'Street Address 1'])
